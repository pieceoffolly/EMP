...
msgname 		db 'Музыкальный Проигрыватель$'   ; program's header
...
;notes frequencies
notes_frequency2 dw 9120,8126,7236,6836,6084,5412,4828 ;second octave
notes_frequency3 dw	4560,4063,3618,3418,3042,2706,2414 ;third octave
notes_frequency4 dw	2280,2031,1809,1709,1521,1353,1207 ;fourth octave
...
xor  	bx,bx
mov 	ah,10
mov 	dx,offset loadstring		; input file name
int		21h
;adding zero to the end of the file
mov 	cl,[loadstring+1]			;calculating file length
adc		ch,0
mov 	si,cx
